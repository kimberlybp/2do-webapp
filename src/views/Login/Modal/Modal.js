...
import { AddTagButton, NewButton } from '../Search';
import { RadioButton, SelectTaskList } from '../Search';
import AddIcon from '@mui/icons-material/Add';
import Divider from '@mui/material/Divider';
import TextField from '@mui/material/TextField';
import { ModuleSearch } from '../Search/Search';
    ...
    <Grid container>
      ...
      >
          <Box sx={{ 
              ...
              <Grid container>
                <Grid container justifyContent="center" sx={{ my:"4%", ml:"6%", mr:"6%" }}>
                    <Grid item xs={12}>
                    ...
                    <Grid item xs={12}>
                        <Grid container direction="row" sx={{ ml:"-2%" }}>
                            ...
                            <Grid item sx={{ mt:{xs:'2%', sm:'1%'}, maxWidth:"75%" }}>
                              <TextField
                                multiline
                                rows={1}
                                variant="standard"
                                ...
                                type="text"
                                sx={{ width:{xs:"150%", sm:"340%", md:"150%", lg:"185%", xl:"260%"}, border:"none", font:"inherit", color:"#6d6d6d"}}
                                InputProps={{disableUnderline: true}}
                              />
                            </Grid>
                        </Grid>
                    ...
                    <Grid item xs={12} sx={{ mt:"1%" }}>
                      <Grid container direction="row">
                        <Grid item xs={6}>
                          ...
                          <Box sx={{ backgroundColor:"#f5f3f3", height:49, mr:'5%', borderRadius:1 }}>
                            <Grid container alignItems="center" >
                              <Typography sx={{ color:"black", mt:{xs:"12%", sm:"6%", md:"7%", lg:"10%", xl:"7%"}, ml:"3%" }}>
                                No Due Date set
                              </Typography>
                            </Grid>
                          </Box>
                    ...
                    <Grid item xs={12}>
                      <Divider sx={{ mt:{ xs:"3%", md:"4%", lg:"2%"} }}></Divider>
                    </Grid>
                    <Grid item xs={12}>
                      <Grid container direction="row">
                        <Grid item xs={11} sm={11.3} md={11} lg={11.3}>
                          <Typography fontWeight={700} sx={{ color:"#6d6d6d", mb:"1%", mt:"1.5%" }}>
                            Remind Me
                          </Typography>
                        </Grid>
                        <Grid item>
                    ...
                    <Grid item xs={12} sx={{ mt:"1%", mb:"7%" }}>
                      <ModuleSearch samplemods={SampleMods} sx={{ width:"100%" }}></ModuleSearch>
                    </Grid>
                </Grid>
                <Grid item xs={12}>
                <Box sx={{ backgroundColor:"#f8f8f8", width:'100%', height:"auto", borderBottomLeftRadius:9, borderBottomRightRadius:9 }}>
                  <Grid container direction="row" justifyContent="flex-end">
                          <NewButton sx={{ my:{xs:"6%", md:"2.5%"}, mr:"3%" }}>
                            <Typography color="black" fontWeight={700}>Cancel</Typography>
                          </NewButton>
                          <PurpleButton sx={{ my:{xs:"6%", md:"2.5%"}, mr:"4%" }}>
                          <Typography color="white" fontWeight={600} letterSpacing={0.5}>Create Task</Typography>
                          </PurpleButton>
                  </Grid>
                </Box>
                </Grid>
